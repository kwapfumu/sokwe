...
* state tree a reducer is a pure function. It only computes the next state. It should be completely
* predictable: calling it with the same inputs many times should produce the same outputs.
* It shouldn't perform any side effects like API calls or router transitions. These should happen
